...
3. Return **test cases + a concise Technical Approach** to the user and wait for
   ...
   - The Technical Approach explains, at a high level, how the change fits the
     existing architecture: which subsystems it touches, the chosen approach versus
     the alternatives, the test coverage to add or adjust, and any notable risks or
     trade-offs.
